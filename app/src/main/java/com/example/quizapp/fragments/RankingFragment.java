...
public class RankingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView txtLevel = view.findViewById(R.id.textLevel);
        ...
        List<Score> scoreList = dbHelper.getScores(categoryId, difficulty);
        txtLevel.setText(difficulty + " Level");

        RecyclerView recyclerView = view.findViewById(R.id.recyclerScore);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        ScoreAdapter adapter = new ScoreAdapter(getActivity(), scoreList);
